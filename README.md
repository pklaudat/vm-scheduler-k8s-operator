...
```sh
make build-installer IMG=<some-registry>/vm-scheduler-operator:tag
```
...
```sh
kubectl apply -f https://raw.githubusercontent.com/<org>/vm-scheduler-operator/<tag or branch>/dist/install.yaml
```
